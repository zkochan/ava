...
In these rare cases you can call `test.serial`, which will force those tests to run serially *before* the concurrent ones.
...
>>>>>>> 46de681... readme: improve transpiling imported modules section
